# Claude Code Prompt — 07. Responsive Editor

## Reference
- UI: `C:\Projects\MDAIW\docs\module-4\01_UI_UX_Designs\07_Responsive_Editor.png`
...
## Goal
Desktop/mobile side-by-side editing, stacking, alignment and mobile-specific overrides.
...
3. Image full width
4. Mobile order
5. Device-specific padding/font/alignment
6. Hide/show per device
7. Preserve desktop values when overriding mobile
...
## Acceptance criteria
Mobile overrides never silently mutate desktop styling and stack order is deterministic.
