# Claude Code Prompt — 05. Layout Builder

## Reference
- UI: `C:\Projects\MDAIW\docs\module-4\01_UI_UX_Designs\05_Layout_Builder.png`
...
## Goal
Column ratios, structure, mobile stacking and content order configuration.

## Implement these operations
1. Select 1–6 columns
2. Set ratios
3. Custom ratios
4. Set mobile stack
5. Set mobile order
6. Set desktop direction
7. Insert layout
8. Validate width totals
...
## Acceptance criteria
All column structures generate deterministic table-safe layout definitions and mobile order metadata.
