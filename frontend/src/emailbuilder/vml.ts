...
//
// Re-exported from vmlBackground.ts (a pure leaf module with no
// dependency on registryCore.tsx/moduleRegistry.tsx) so registryCore.tsx
// can reuse this SAME renderer for the whole-module Layout Background
// wrapper without a circular import (this file itself imports
// resolveModuleDefinition FROM registryCore.tsx above) — see
// vmlBackground.ts's own docstring. Every existing import site keeps
// working unchanged.
export {
  renderVmlBackground, estimateVmlBackgroundHeightPx, estimateColumnVmlContentAllowancePx,
  type VmlBackgroundInput,
} from './vmlBackground';
